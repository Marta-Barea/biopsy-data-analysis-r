...
```{r fig.cap="Imagen histológica de células de cáncer de mama observadas al microscopio.\\\\[6pt] \\centering \\footnotesize\\textit{Fuente externa: Agencia SINC (2023). \\href{https://www.agenciasinc.es/Noticias/Identifican-como-las-celulas-tumorales-del-cancer-de-mama-se-liberan-y-forman-metastasis}{Ver artículo}}", echo=FALSE, out.width="0.6\\linewidth", fig.align="center", fig.pos="H"}
